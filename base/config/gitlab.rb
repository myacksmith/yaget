...
# gitlab_rails['gitlab_ssh_host'] = 'ssh.host_gitlab.local'
...
##! If your SMTP server does not like the default 'From: gitlab@gitlab.gitlab.local'
##! can change the 'From' with this setting.
# gitlab_rails['gitlab_email_from'] = 'example@gitlab.local'
...
###! install
# gitlab_rails['mattermost_host'] = "https://mattermost.gitlab.local"
...
# gitlab_rails['smartcard_client_certificate_required_host'] = 'smartcard.gitlab.gitlab.local'
...
# gitlab_rails['forti_authenticator_host'] = 'forti_authenticator.gitlab.local'
...
# gitlab_rails['duo_auth_hostname'] = 'duo_auth.gitlab.local'
...
# gitlab_rails['clickhouse_databases']['main']['url'] = 'https://gitlab.local/path'
...
# gitlab_rails['registry_host'] = "registry.gitlab.gitlab.local"
...
#   {
#     'name' => 'test_endpoint',
#     'url' => 'https://gitlab.gitlab.local/notify2',
#     'timeout' => '500ms',
...
# gitlab_kas_external_url "ws://gitlab.gitlab.local/-/kubernetes-agent/"
...
# mattermost['gitlab_auth_endpoint'] = "http://gitlab.gitlab.local/oauth/authorize"
# mattermost['gitlab_token_endpoint'] = "http://gitlab.gitlab.local/oauth/token"
# mattermost['gitlab_user_api_endpoint'] = "http://gitlab.gitlab.local/api/v4/user"
...
#       { key: 'http.http://gitlab.local.proxy', value: 'http://example.proxy.com' },
#     ],
#   },
#   gitlab: {
...
# gitlab_rails['kerberos_service_principal_name'] = HTTP/gitlab.gitlab.local@gitlab.local
# gitlab_rails['kerberos_simple_ldap_linking_allowed_realms'] = ['gitlab.local','kerberos.gitlab.local']
...
################################################################################
# gitlab_rails['db_load_balancing'] = { 'hosts' => ['secondary1.gitlab.local'] }
...
# gitlab_rails['geo_registry_replication_primary_api_url'] = 'https://gitlab.local:5050'
